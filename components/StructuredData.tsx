export default function StructuredData() {
  const organizationSchema = {
    ...
    "name": "•BR Precision• | •Bath Resin Company Ltd•",
    "alternateName": ["Bath Resin Company", "BR Landscapes", "BR/Bath Resin Company", "BR Precision"],
    "legalName": "Bath Resin Company Ltd",
    "description": "•BR Precision• | •Bath Resin Company Ltd• - Family-run resin driveway and landscaping specialists in Bath, Somerset. Over 20 years of experience creating beautiful, lasting outdoor spaces. Professional resin bound driveways, tarmac services, garden transformations, and landscaping. NVQ qualified, CPCS certified, City & Guilds trained, SWQR streetworks approved.",
